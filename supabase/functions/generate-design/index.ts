...
function buildPrompt(
  ...
  const noExtraTextRule = `\n\n🚫 ABSOLUTELY NO EXTRA TEXT: The design must contain ONLY the exact text provided above in "TEXT TO FEATURE". Do NOT add any additional words, taglines, slogans, brand names, dates, or decorative text. If the message already includes an attribution (like "— the universe"), that is part of the provided text. Do NOT invent or add anything else.\n\n🚫 NO DETAILED HUMAN FIGURES: Do NOT include detailed human figures, astronauts, realistic people, faces, or body parts. Abstract silhouettes or minimal human outlines are acceptable if they serve the design, but avoid anything that feels heavy or depressing. Prefer abstract shapes, objects, symbols, nature elements, or pure typography as the primary visual language.`;

...
export function OnboardingTour({ onClose }: OnboardingTourProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => { if (!localStorage.getItem("brand_aura_tour_seen")) localStorage.setItem("brand_aura_tour_seen", "1"); onClose(); }}>
      <div
